...
/**
 * This class provides a multidimensional base distribution with dependent/independent dimensions, 
 * where each cluster prior is a multivariate normal distribution whose parameters
 * come from a normal-inverse-wishart distribution.
 * 
 * @author Thomas J. Glassen
 */

//this class is from the package ojAlgo: http://ojalgo.org/
