...
public class PartitionDistribution {
	...
	public long getMaxNumOfAgreements() {
		return partitions.length * partitions[0].length * (partitions[0].length - 1) / 2 - getMinNumOfDisagreements();
	}
	 ...
	 * The standardization of Meila (Comparing Clusterings - An Axiomatic View; 2005)
	 * is used.
	 * runtime: O(N^2 * K)
	 */
